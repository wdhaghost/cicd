...
@section('content')
    <div class="container mx-auto mt-5">
        ...
        <div class="card p-2 w-50">
            ...
            <div class="card-body">
                <ul class="list-group">
                    <li class="list-group-item"><a href="{{ route('loans.index') }}" class="card-link">Liste des matériels</a></li>
                    <li class="list-group-item">  <a href="{{ route('loans.create') }}" class="card-link">Ajouter du matériel</a>    </li>
                </ul>
            </div>
